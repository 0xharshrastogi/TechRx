...
from typing import Callable, Awaitable, Any, Text, Optional, Dict
...
from sanic import Request, Blueprint, HTTPResponse, response
...
class RestInputBot(InputChannel):
    ...
    def get_latest_model(self) -> str:
        ...
        try:
            ...
            resp = max(list_of_files, key=os.path.getctime)
    ...
    def blueprint(
        ...
        async def bot_response(request: Request) -> HTTPResponse:
            ...
            resp = response.json(result, content_type="text/html")
